...
int main(){
    ...
    cout << "The deck contains " << deck.deckSize() << endl;

    cout << endl;

    cout << "The hand contains " << hand.handSize() << endl;
    ...
    cout << "The deck now contains " << deck.deckSize() << endl;

    cout << endl;

    cout << "The hand now contains " << hand.handSize() << endl;
