...
int main()
{
    ...
    std::cout << "State of a valid map: "
              << validMap.getErrorString(validMap.validate()) << std::endl;
    ...
    for (std::size_t run = 0; run < 10; ++run)
    {
        ...
        std::cout << "State of disconnected graph: "
                  << runMap.getErrorString(runMap.validate()) << std::endl;
    }
    ...
    std::cout << "State of invalid territory ownership map: "
              << invalidBelonging.getErrorString(invalidBelonging.validate())
              << std::endl;
